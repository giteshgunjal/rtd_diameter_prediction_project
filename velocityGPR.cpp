...
public:
    ...
    //     MatrixXd pred_cov;
    //     };
    // typedef struct predData PredStruct;

    // velo_GPR()
    // {


    //     subOdom = nh.subscribe<nav_msgs::Odometry>  (odomTopic,2000, &velo_GPR::odom_handler, this, ros::TransportHints().tcpNoDelay());
...
// no need to scale time we are going to do a recursive bayesian update. gpr output will be cov 
    ...
    {  
        ...
        cout<<ytrain - pred_data<<endl;
        cout<<(ytrain - pred_data).size()<<endl;
    ...
    void traj_pred()
    {
        ...
        {   
            ...
            {   
                ...
                cout<< linearVelocityBuffer.mean()<<endl;
