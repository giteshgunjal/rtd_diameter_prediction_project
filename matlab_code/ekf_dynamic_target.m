...
u = 5;
v = 0.01;
r = zeros(length((h(2:end) - h(1:end-1)) ./ (t(2:end) - t(1:end-1))))+0.5;%(h(2:end) - h(1:end-1)) ./ (t(2:end) - t(1:end-1));
gt(1, :) = [0, 0, 0];
for i = 2:length(h)
